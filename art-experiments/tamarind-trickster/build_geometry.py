...
for side in ['R','L']:
 ...
 ns=['Chest_M','Scapula_'+side,'Shoulder_'+side];start=b.B['Chest_M']+[sg*.12,.20,0];end=b.B['Shoulder_'+side];b.tube('Soft shoulder '+side,[start,(start+end)/2,end],[.13,.125,.118],[.12,.115,.11],[{'Chest_M':.85,'Scapula_'+side:.15},{'Scapula_'+side:.5,'Shoulder_'+side:.5},'Shoulder_'+side],1,axis=(0,1,0))
 ...
 ns=['Wrist_'+side,'MiddleFinger1_'+side,'MiddleFinger2_'+side];pts=[b.B[n]for n in ns]+[b.B['MiddleFinger3_'+side]*.982];b.tube('Broad hand fingers '+side,pts,[.062,.075,.050,.020],[.06,.055,.035,.018],ns+[ns[-1]],6,axis=(0,1,0))
