...
b.ellipsoid('Plum pitcher hood',[0,1.22,.12],[.285,.195,.22],'Head',[4,5,6,5,4,5,6,5,4,5])
b.ellipsoid('Dark recessed mouth',[0,1.195,.310],[.232,.133,.030],'Head',10)
b.ellipsoid('Amber throat',[0,1.18,.342],[.082,.052,.016],'Head',8)
...
b.tube('Copper lower articulated pitcher rim',lower,[.035]*9,[.033]*9,['Jaw']*9,8,axis=(0,0,1),sides=6)
