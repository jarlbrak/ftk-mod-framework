...
for name,rid in [('bronzewake_body', 121272), ('bronzewake_hair', 121500), ('bronzewake_armor', 121522), ('bronzewake_boots', 121661)]:
 ...
 v=json.loads((OUT/f'{name}.validation.json').read_text());b=json.loads((ROOT/f'scratch/bronzewake-roundtrip/{name}.validation.json').read_text())
