...
files = []
for name in (
    "abyssal-crown-kraken-head-v2.source.json", "abyssal-crown-kraken-head-v2.png", "abyssal-crown-kraken-head-v2.pieces.json",
    "sargassum-kraken-tentacle-v2.source.json", "sargassum-kraken-tentacle-v2.png", "sargassum-kraken-tentacle-v2.pieces.json",
    "royal-sargassum-seaking-tentacle-v3.source.json", "royal-sargassum-seaking-tentacle-v3.png", "royal-sargassum-seaking-tentacle-v3.pieces.json",
):
