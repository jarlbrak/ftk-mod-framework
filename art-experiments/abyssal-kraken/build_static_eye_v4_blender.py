#!/usr/bin/env python3
"""Create editable Blender source and studio views for the compact V4 rigid Kraken eye companion."""
...
def make_source():
    ...
    obj["ftk_art_status"] = "Original compact V4 static companion. Export through build_static_eye.py."
    uv = mesh.uv_layers.new(name="Abyssal V4 eye original UV")
    ...
    image.pack()
    material = bpy.data.materials.new("Abyssal V4 eye original palette")
...
def render_studio(obj):
    ...
    world = bpy.data.worlds.new("Abyssal V4 eye studio")
    ...
    floor_material = bpy.data.materials.new("Abyssal V4 eye studio floor")
...
def main():
    ...
    VALIDATION.write_text(json.dumps({
        "status": "PASS_ABYSSAL_KRAKEN_STATIC_EYE_V4_BLEND_REOPEN",
        "asset": ASSET,
    ...
    print(json.dumps({"status": "PASS_ABYSSAL_KRAKEN_STATIC_EYE_V4_BLEND_REOPEN", "asset": ASSET}, indent=2))
