...
for name,rid in [('briarback',120991)]:
 ...
 v=json.loads((OUT/f'{name}.validation.json').read_text());b=json.loads((ROOT/f'scratch/briarback-roundtrip/{name}.validation.json').read_text())
