...
for name,rid in [('emberjaw_top',121577),('emberjaw_bottom',121483)]:
 ...
 v=json.loads((OUT/f'{name}.validation.json').read_text());b=json.loads((ROOT/f'scratch/emberjaw-roundtrip/{name}.validation.json').read_text())
