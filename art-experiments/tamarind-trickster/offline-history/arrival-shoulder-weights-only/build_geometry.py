...
for side in ['R','L']:
 ...
 ns=['Chest_M','Scapula_'+side,'Shoulder_'+side];b.tube('Soft shoulder '+side,[b.B[ns[0]]+[sg*.12,.11,0],b.B[ns[1]],b.B[ns[2]]],[.145,.132,.115],[.13,.12,.11],[{'Chest_M':.85,'Scapula_'+side:.15},{'Scapula_'+side:.5,'Shoulder_'+side:.5},'Shoulder_'+side],1,axis=(0,1,0))
