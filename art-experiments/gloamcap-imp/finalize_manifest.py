...
for name,rid in [('gloamcap',121117)]:
 ...
 v=json.loads((OUT/f'{name}.validation.json').read_text());b=json.loads((ROOT/f'scratch/gloamcap-roundtrip/{name}.validation.json').read_text())
