...
Custom realms and bespoke boss campaigns are not bundled content. They remain an authoring area that needs fresh, route-specific validation before a package can claim solo, save, or co-op support.
