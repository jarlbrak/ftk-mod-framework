...
for name,rid in [('lunacrest',121306)]:
 ...
 v=json.loads((OUT/f'{name}.validation.json').read_text());b=json.loads((ROOT/f'scratch/lunacrest-roundtrip/{name}.validation.json').read_text())
...
manifest['art_status']='Original hinged clam surface model; manual studio and live acceptance pending after regeneration'
