...
namespace FTKModFramework.Core
{
    ...
    /// class. The cleanup is LOAD-BEARING: once the Phase-2 trigger patches land, a leftover probe binding on
    /// the Thief (or any vanilla class) would become a live combat negate. Runs alongside the other
    /// sample-content self-tests (see AdventureContent), so the Thief row it binds to is guaranteed present.
    /// </summary>
