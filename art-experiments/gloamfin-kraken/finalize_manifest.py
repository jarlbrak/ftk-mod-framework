...
for name,rid in [('gloamfin',121260)]:
 ...
 v=json.loads((OUT/f'{name}.validation.json').read_text());b=json.loads((ROOT/f'scratch/gloamfin-roundtrip/{name}.validation.json').read_text())
...
manifest['art_status']='Original Kraken head blockout; manual studio and live acceptance pending after regeneration'
