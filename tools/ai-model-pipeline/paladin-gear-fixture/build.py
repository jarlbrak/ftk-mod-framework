...
def build(output):
    ...
    (output / 'NEVER-PUBLISH.txt').write_text('TEST FIXTURE ONLY. All 36 gear items are starting inventory grants. Use only as the sole Paladin package in an isolated new-save trial. Never publish or install alongside the production package.\n')
