...
for name,rid in [('honeyback_portrait_v2',121467)]:
 ...
 v=json.loads((OUT/f'{name}.validation.json').read_text());b=json.loads((ROOT/f'scratch/honeyback-portrait-v2-roundtrip/{name}.validation.json').read_text())
