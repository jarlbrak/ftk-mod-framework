#!/usr/bin/env python3
"""Rebuild Lichenfang and prove its original authored output is reproducible."""
...
def main() -> None:
    ...
    parser.add_argument("--output-dir", type=Path,
                        default=ROOT / "scratch" / "lichenfang-basey-wolf-proof-rerun")
    ...
    files = ["lichenfang.glb", "lichenfang-palette.png", "lichenfang.source.json", "lichenfang.pieces.json"]
    checks = []
