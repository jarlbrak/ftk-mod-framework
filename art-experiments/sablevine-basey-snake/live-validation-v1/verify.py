#!/usr/bin/env python3
"""Independently verify Sablevine Serpent's immutable V1 live archive."""
...
OUT = ROOT / "art-experiments" / "sablevine-basey-snake" / "live-validation-v1"
...
assert validation["status"] == "reviewed_resource_enbaseysnake_binding_motion_gameplay_observed_camera_fit_rejected"
...
assert validation["profile"]["key"] == validation["enemy"] == "ftkmf_modeltest_sablevine_basey_snake"
...
assert by_action["attack"]["causalMotion"]["hit"]["nativeAction"]["primary"]["newHealth"] == 50
...
assert ordinary == {
    ...
    "beforeHp": 58, "afterHp": 50, "clip": "Snake_HitSmall",
