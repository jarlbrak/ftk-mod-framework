...
for sign in [-1,1]:
 b.ellipsoid('Small dark eye '+str(sign),[sign*.225,1.73,.329],[.071,.080,.052],'Eyes',10)
 b.ellipsoid('Restrained eye glint '+str(sign),[sign*.207,1.755,.373],[.017,.023,.009],'Eyes',5)
