...
for name,rid in [('vesper_body',121031),('vesper_eye',121210)]:
 ...
 v=json.loads((OUT/f'{name}.validation.json').read_text());b=json.loads((ROOT/f'scratch/vesper-roundtrip/{name}.validation.json').read_text())
