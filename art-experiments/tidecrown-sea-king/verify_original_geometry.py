#!/usr/bin/env python3
"""Prove Tidecrown's authoring generator reads binding metadata only."""
import hashlib
import json
import sys
...
TARGET = ROOT / 'scratch/tidecrown-sea-king-original-proof'
...
try:
    ...
    # The provenance proof owns source regeneration only.  The normal build and
    # Blender bridge independently run the actual writer and validator.
...
files = []
for name in ('tidecrown-sea-king.source.json', 'tidecrown-sea-king_basecolor.png', 'tidecrown-sea-king.pieces.json'):
