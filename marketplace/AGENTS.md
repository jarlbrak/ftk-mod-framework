...
- Paladin is the first published package and the sole production catalog example at 1.0.0.
...
- Corrections require a new version and archive. Do not replace published bytes.
