...
import numpy as np
OUT=Path(__file__).resolve().parent;ROOT=OUT.parent.parent;target=ROOT/'scratch/mournglass-original-proof';target.mkdir(exist_ok=True)
...
files=[]
for name in ['mournglass.source.json','mournglass_basecolor.png','mournglass.pieces.json','mournglass.slot0.png','mournglass.slot1.png']:
