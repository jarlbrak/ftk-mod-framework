...
for name,rid in [('rimecrown_hat', 121404), ('rimecrown_head', 121414), ('rimecrown_base', 121556), ('rimecrown_scarf', 121638), ('rimecrown_body', 121696)]:
 ...
 v=json.loads((OUT/f'{name}.validation.json').read_text());b=json.loads((ROOT/f'scratch/rimecrown-roundtrip/{name}.validation.json').read_text())
