#!/usr/bin/env python3
"""Record the exact Jungle Snake C palette and inverse binds used by Bramblecoil."""
import hashlib
import json
...
reference_path = ROOT / "scratch/skeleton-audit/121424/reference.npz"
reference = np.load(reference_path, allow_pickle=False)
source = OUT / "bramblecoil-jungle-snake.source.json"
...
assert len(data["bone_names"]) == 44
assert all(name in index for name in ("Root_M", "Head", "Jaw", "Tongue_07"))
...
result = {
    ...
    "bindingLandmarks": {
        ...
        for name in (
            ...
            "Head", "joint13", "Jaw", "Jaw_End", "Tongue_01", "Tongue_07",
        )
    },
    ...
    "scope": "Exact palette and bind identity for snakeJungleC/enJungleSnakeC. It does not establish source-surface similarity, animation safety, portrait framing, material behavior, culling, ragdoll, or live art acceptance.",
}
