#!/usr/bin/env python3
"""Review and, only with --execute, deploy the V5 Kraken head reattached-eye stage."""
...
assert receipt["status"] == "STAGED_NOT_DEPLOYED_ABYSSAL_KRAKEN_V5_HEAD_REATTACHED_EYE"
...
assert_game_stopped(GAME)
backup = GAME / "deployment-backups" / ("abyssal-kraken-v5-head-reattached-eye-" + datetime.datetime.now().strftime("%Y%m%d-%H%M%S"))
