#!/usr/bin/env python3
"""Archive the fresh Emberglass Bee trial without game payloads."""
...
SESSION = "59cde8c216d54a79b5d22fab5ac82d0c"
CASE = BASE / "case-7e7f3fd494ea4db5a4468b2bdaf58525" / "case-result.json"
JOURNAL = BASE / "case-7e7f3fd494ea4db5a4468b2bdaf58525" / "journal.jsonl"
PROFILE = ROOT / "scratch" / "mirewarden-game" / "model-test-profiles.json"
REVIEW = ROOT / "scratch" / "emberglass-root-visual-review.json"
...
assert review["binding"]["nativeChassis"] == "beeA"
assert review["binding"]["ownerInstanceId"] == 369188
assert [item["rendererPath"] for item in review["binding"]["renderers"]] == ["Monster Bee"]
...
capture_ids = []
capture_counts = {"pass": 120, "attack": 120, "kill-fixture": 104}
for action in case["actions"]:
    ...
    capture_ids.append((label, raw.stem, expected))
...
for label, capture_id, count in capture_ids:
    ...
    captures.append({
        ...
        "complete": count == 120,
        "termination": None if count == 120 else "renderer_destroyed",
    })

validation = {
    "status": "fresh_catalog_411_single_renderer_binding_appearance_motion_and_progression_observed_with_expected_death_prefix",
    "session": SESSION,
    "enemy": "ftkmf_modeltest_emberglass",
    "displayName": "Emberglass Bee",
    "nativeChassis": "beeA",
