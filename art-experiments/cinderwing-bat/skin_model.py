"""Blend original body geometry to local batA, with explicit rigid face/claw details."""
import sys,json
...
reference=np.load(ROOT/'scratch/model-reference/bat-a/reference.npz')
...
write_glb(OUT/'cinderwing_rigged.glb',data,reference)
