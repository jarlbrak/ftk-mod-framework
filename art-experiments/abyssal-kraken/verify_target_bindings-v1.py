...
records = [
    inspect("abyssal-crown-kraken-head", 121035, "krakenHead", "kraken2"),
    inspect("sargassum-kraken-tentacle", 121595, "krakenTentacle", "krakenTentacle"),
    inspect("sargassum-seaking-tentacle", 121315, "seaKingTentacleA/B", "KrakenGodTentacle"),
]
