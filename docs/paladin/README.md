...
[1.2.0 package](../../marketplace/packages/paladin/README.md) tunes Vitality
...
to understand the authored content. The [1.2.0 publication receipt](PUBLICATION-1.2.0.md) records the artifact verification. The [launch record](LAUNCH-1.0.0.md)
