...
for name,rid in [('honeyback',121467)]:
 ...
 v=json.loads((OUT/f'{name}.validation.json').read_text());b=json.loads((ROOT/f'scratch/honeyback-roundtrip/{name}.validation.json').read_text())
