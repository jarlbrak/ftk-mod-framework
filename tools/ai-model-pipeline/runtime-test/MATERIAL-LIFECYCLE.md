...
## Independently audited native run

The [lossless native evidence](../../../docs/evidence/material-lifecycle-native-v1/README.md)
passes the standalone raw-data audit: two22-frame lineages,100 phase calculations
with maximum error0, exact source/clone/grandclone private-material joins, a
never-enabled renderer, both teardown orders and all nine retired resource IDs
per lineage measured Unity-null with absent leases. Thirteen corruption tests
and architect review passed. This closes the bounded owned no-CEL fixture gate;
it does not establish public GLB transaction or native avatar lifetime behavior.
The direct prefix-rejection assertions remain runtime-reported, not independently
reconstructed from raw atomic snapshots. All other exclusions above remain.
