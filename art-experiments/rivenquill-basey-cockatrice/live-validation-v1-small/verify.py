#!/usr/bin/env python3
"""Independently verify the immutable Rivenquill Cockatrice small archive."""
...
OUT = ROOT / "art-experiments" / "rivenquill-basey-cockatrice" / "live-validation-v1-small"
...
assert validation["status"] == "reviewed_resource_enbaseycockatricesmall_binding_motion_gameplay_observed_camera_fit_accepted_limited_art_pending"
assert validation["revision"] == "V1-small"
...
assert len(selected) == len(review["frames"]) == 16
...
assert captures["kill-fixture"]["complete"] is True and captures["kill-fixture"]["frameCount"] == 120
assert captures["kill-fixture"]["termination"] is None
...
assert validation["ordinaryHit"] == {
    ...
    "beforeHp": 72, "afterHp": 62, "nativeTrigger": "Damaged",
