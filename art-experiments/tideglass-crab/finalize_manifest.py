...
for name,rid in [('tideglass',121411)]:
 ...
 v=json.loads((OUT/f'{name}.validation.json').read_text());b=json.loads((ROOT/f'scratch/tideglass-roundtrip/{name}.validation.json').read_text())
