#!/usr/bin/env python3
"""Review and, only with --execute, deploy a staged V3 Sea King art correction."""
...
assert receipt["status"] == "STAGED_NOT_DEPLOYED_ABYSSAL_KRAKEN_V3_SEAKING_ART_CORRECTION"
...
review = {
    ...
    "retainedV2Assets": receipt["retainedV2Assets"],
...
assert_game_stopped(GAME)
backup = GAME / "deployment-backups" / ("abyssal-kraken-v3-seaking-" + datetime.datetime.now().strftime("%Y%m%d-%H%M%S"))
