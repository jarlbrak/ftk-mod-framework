...
OPS = ('material-lifecycle-fixture', 'native-row-portrait-fixture', 'portrait-texture-capture', 'inventory', 'reload', 'capture', 'play', 'select-room', 'stage-enemy', 'fortify-party', 'return-to-title', 'quiet-tutorials', 'lease-test', 'stage-next-enemy', 'ready', 'fixture-state', 'collect-loot', 'equipment-inventory', 'equip-body', 'unequip-body', 'catalog-preflight', 'playercatalog-preflight', 'material-state', 'story-state', 'story-submit', 'player-preview-state', 'lease-watch-preview', 'lease-watch', 'lease-watch-state', 'lease-watch-clear', 'kraken-sample-fixture')
