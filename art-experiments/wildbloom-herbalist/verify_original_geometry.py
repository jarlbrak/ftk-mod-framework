#!/usr/bin/env python3
"""Prove Wildbloom authoring consumes only selected binding metadata."""
...
class BindingOnly:
    """Reject accidental reads of native surfaces while regenerating authoring data."""
...
def main() -> None:
    ...
    parser.add_argument("--output-dir", type=Path,
                        default=ROOT / "scratch" / "wildbloom-herbalist-original-proof")
    ...
    names = ["wildbloom-palette.png"]
    for asset in ("wildbloom-body", "wildbloom-hair-top", "wildbloom-hair-bottom"):
