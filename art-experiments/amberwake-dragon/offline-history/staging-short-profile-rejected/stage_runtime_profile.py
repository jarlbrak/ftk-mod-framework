...
profile={'key':'ftkmf_modeltest_amberwake','baseEnemy':'dragonFrost','displayName':'Amberwake Dragon','combatProfile':read(A/'source-findings.json')['mapping']['renderers'][0]['combat_profile_fingerprint'],'renderers':[{'rendererPath':'enDragon','glbFile':'amberwake.glb','textureFile':'amberwake_basecolor.png','disableNativeEmission':True}],'visualScale':0.25}
